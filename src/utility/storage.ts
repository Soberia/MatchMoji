...
function defaultLocalSettingGenerator() {
  return {
    ...
    theme: window.matchMedia(`(prefers-color-scheme: ${Theme.Light})`).matches
      ? Theme.Light
      : Theme.Dark,
    effects: !window.matchMedia('(prefers-reduced-motion)').matches,
    sound: true,
    vibration: true,
    backgroundMusic: true,
    emojiVariants: true,
    emojiGroups: Object.values(EmojiGroups) as EmojiGroups[],
    font: Font.Default,
